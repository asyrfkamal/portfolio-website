    ...
    <section id="projects" className="projects">
      ...
      >
        <SwiperSlide>
          <article className="project-card">
            <div className="project-card__image">
              <img src={prop1} alt="project-pic" loading="lazy" />
            </div>
            <div className="project-card__content">
              ...
              <p className="project-card__desc">
                ...
                University of Warwick I am a Malaysian sophomore computer
                scientist studying in the University of Warwick
              </p>
            </div>
        ...
        <SwiperSlide>
          <article className="project-card">
            <div className="project-card__image">
              <img src={prop2} alt="project-pic" loading="lazy" />
            </div>
            <div className="project-card__content">
              <h4 className="project-card__title">Pixel Art Website</h4>
              <p className="project-card__desc">
                ...
                <br />I am a Malaysian sophomore computer scientist studying in
